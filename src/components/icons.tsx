...
/** Marca de la tienda: silueta de camiseta minimalista (monocroma). */
export const JerseyIcon = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    ...
    aria-hidden
  >
    <path d="M8.5 3 4 5.5 5.8 9l2.2-1v11h8V8l2.2 1L20 5.5 15.5 3a3.5 3.5 0 0 1-7 0Z" />
  </svg>
)
